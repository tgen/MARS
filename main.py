...
def interpret_featurecounts(filepath, samplename):
    ...
    reads = pd.read_csv(r'%s/Updated_test4.txt' % filepath, sep='\t', lineterminator='\n',
                        skiprows=(0), header=(1))
    ...
    summary = pd.read_csv(r'%s/Updated_test4.txt.summary' % filepath, sep='\t',
                          lineterminator='\n', skiprows=(0), header=(0))
...
if build == 'Y': # & in_gtf != '':
    ...
    loci_gtf = open(r'%s/Immunoglobulin_GRCh38_Loci.gtf' % out_path, 'r')
    ...
    contaminant_file = open(r'%s/Non_Bcell_Contamination_GeneList_e98.txt' % out_path, 'r')
